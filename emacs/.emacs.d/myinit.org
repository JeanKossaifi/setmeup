...
* Theme
*Source*: [[https://github.com/danielmai/.emacs.d/blob/master/config.org][Daniel Mai's config.org]] and [[https://github.com/sandhu/emacs.d/blob/master/config/008-ui-config.el][Sandhu's emacs config]]
...
#+END_SRC
* powerline
*Source:* [[https://github.com/sandhu/emacs.d/blob/master/config/008-ui-config.el][Sandhu's emacs config]]
